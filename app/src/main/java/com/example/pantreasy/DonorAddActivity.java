...
public class DonorAddActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        foodName = layout.findViewById(R.id.food_name_text);
        blurredBackground = layout.findViewById(R.id.blurred_background);
    ...
    private void setOnClickForClearButton() {
        clearList.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ConstraintLayout view = (ConstraintLayout) findViewById(R.id.donor_add);
                view.setDrawingCacheEnabled(true);
                view.buildDrawingCache();
                Bitmap bm = view.getDrawingCache();
                Bitmap blurBm = fastblur(bm, 1,20);
                blurredBackground.setImageBitmap(blurBm);
